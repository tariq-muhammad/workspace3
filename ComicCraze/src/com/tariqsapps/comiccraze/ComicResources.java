...
public class ComicResources extends ListActivity implements OnItemClickListener {
	...
	ListView movieList;
	String[] someItems = {"COMICBOOK.COM","SUPERHEROHYPE.COM","COMIXOLOGY.COM","COMICBOOKRESOURCES.COM","SCREENRANT.COM","TALKINGCOMICBOOKS.COM","COMICSBEAT.COM","COMICSALLIANCE.COM",
			              "COMICSWORTHREADING.COM","COMICBOOKMOVIE.COM"};
